        ...
        <View
          ...
          <View className="resultList">
                ...
                return (
                  <View className="result-item" key={item.i}>
                    ...
                    <View className="typeResult">
                      ...
                      <View className="result">{Names[seletype] == Names[item.c-1] ? '✔' : <Text>{Names[seletype]}</Text>}</View>
                    </View>
                  </View>
                )
              })
            ...
            <View className="btnList">
              <View className="btn1" onClick={this.dataInit}>再试一次</View>
              <Button className="btn2" openType="share">考考别人</Button>
            </View>
            <View
              className="foot"
