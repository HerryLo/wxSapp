...
目前支持了微信小程序CI工具，一键发布，非常的舒适，[我的微信小程序CI工具配置源码](https://github.com/HerryLo/wxSapp/blob/master/config/upload.wx.js)，可以看看这篇文章：[微信小程序CI工具](https://zhuanlan.zhihu.com/p/147839106)
